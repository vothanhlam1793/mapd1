...
class View {
    ...
    _initInteractive(){
        ...
        this.layer1.on('dragstart', function(){
            // console.log("layer1 - start");
        })
        this.layer1.on('dragmove', function(){
            // console.log("layer1 - move");
            // if(that.layer1.y() + that.stage.y() > 0){
            //     that.layer1.y(-that.stage.y());
            // } else if (that.layer1.height() - that.layer1.y() > that.background.scaleY()*that.background.height()){
            //     that.layer1.y(that.background.scaleY()*that.background.height() - that.layer1.height());
            // }

        })
        this.layer1.on('dragend', function(){
            // console.log("layer1 - end");
        })
